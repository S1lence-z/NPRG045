...
class ServiceExtendedResultEncoder(json.JSONEncoder):
    ...
    def default(self, object: DetectorResult) -> str:
        if isinstance(object, DetectorResult):
            return {
                ...
                'service_extended_result': [ServiceExtendedResultEncoder().default(ser) for ser in object.service_extended_result],
            }